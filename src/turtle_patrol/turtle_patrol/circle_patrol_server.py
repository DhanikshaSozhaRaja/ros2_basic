...
class CirclePatrolServer(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('Circle Patrol Action Server Started')
    ...
    async def execute_callback(self, goal_handle):
        ...
        self.get_logger().info(
            f'Executing circle with radius {radius}'
        )
        ...
        while rclpy.ok():
            ...
            if (
                total_distance >= circumference - 0.5 and
        ...
        result = ExecuteCircle.Result()
        result.success = True
        result.final_report = 'Circle patrol completed successfully'
